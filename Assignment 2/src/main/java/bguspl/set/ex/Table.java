...
public class Table {
     ...
     * @pre- the slot which we want to add on it the card should be null
     ...
     * @pre - the slot which we want to delete not null
     * @post - the slot which deleted changed to null
     */
